        ...
        <!-- Content Header (Page header) -->
          <section class="content-header">
            ...
            <ol class="breadcrumb">
              ...
              <li><a href="<?php echo base_url(); ?>general/surat_keluar">Surat Keluar</a></li>
          ...
          <section class="content">
            <div class="box box-info">
              ...
              <div class="box-body">
                <!-- form start -->
                <?php echo form_open('general/insert_surat_keluar'); ?>
                  ...
                  <a href="<?php echo base_url(); ?>general/surat_keluar" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Batal</a>
