        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">             
              ...
              <li class="dropdown">
        			  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Welcome, ADMIN <span class="caret"></span></a>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="<?php if($page == 'himpunan'){echo 'active';} ?>">
              <a href="<?php echo base_url(); ?>admin/himpunan">
                <i class="fa fa-twitch"></i> <span>Value</span>
              </a>
            </li>
            <li class="<?php if($page == 'kriteria'){echo 'active';} ?>">
              <a href="<?php echo base_url(); ?>admin/kriteria">
                <i class="fa fa-twitch"></i> <span>Kriteria</span>
              </a>
            </li>
            <li class="<?php if($page == 'kriteria_khusus'){echo 'active';} ?>">
              <a href="<?php echo base_url(); ?>admin/kriteria_khusus">
                <i class="fa fa-twitch"></i> <span>Kriteria Khusus</span>
              </a>
            </li>
          </ul>
        </section>
