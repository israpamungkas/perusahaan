                ...
                <div class="box-body table-responsive no-padding">
                  ...
                  <table id="example1" class="table table-bordered table-hover dataTable">
                    ...
                    <tbody>
                        ...
                        <td><?php echo ucwords($lihat->pengetahuan)?></td>
                    		<td><?php echo ucwords($lihat->ketelitian)?></td>
                        <td><?php echo ucwords($lihat->keputusan)?></td>
                        <td><?php echo ucwords($lihat->tanggung_jwb)?></td>
                        <td><?php echo ucwords($lihat->hasil_kerjaan)?></td>
                        <td><?php echo ucwords($lihat->jumlah_skala)?></td>
                        <td><?php echo ucwords($lihat->jumlah_vektor)?></td>
                        <td><?php echo ucwords($lihat->bobot)?></td>     
                        <td><?php echo ucwords($lihat->bobot_akhir)?></td>         		
                    	</tr>
                    	<?php endforeach; ?>
                    </tbody>
                  </table>
