<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-lime">
                ...
                <a href="<?php echo base_url(); ?>admin/input_nilai" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
             ...
             <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-maroon-active">
                ...
                <a href="<?php echo base_url(); ?>admin/himpunan" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
          </div><!-- /.row -->
          ...
          <div class="row">
                <div class="col-md-6">
                    <div id="chart-score" style="width: 700px; height: 300px;"></div>
                </div>
                <div class="col-md-6">
                    <div id="chart-status" style="width: 700px; height: 300px;"></div>
                </div>                    
          </div>
...
<script type="text/javascript">
      ...
      function drawChart() {
        var jsonData1 = $.ajax({
            url: "<?php echo base_url().'admin/get_score_category';?>",
            dataType: "json",
            async: false
        }).responseText;

        var jsonData2 = $.ajax({
            url: "<?php echo base_url().'admin/get_data_status';?>",
            dataType: "json",
            async: false
        }).responseText;
        ...
        var options1 = {
          title: 'Persentase nilai seluruh karyawan Altima Mandiri'
        };
